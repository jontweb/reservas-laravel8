...
class WebsiteController extends Controller
{
    ...
    public function getTopServices()
    {
        $data =  SchServiceBooking::join('sch_services', 'sch_service_bookings.sch_service_id', '=', 'sch_services.id')
            ->selectRaw('sch_service_id,sch_services.title,sch_services.remarks,sch_services.image,count(sch_service_bookings.sch_service_id) as service_count')
    ...
    public function getSiteService()
    {
        ...
        $data =  SchServices::select('title', 'image', 'price', 'remarks', 'time_slot_in_time', 'appoinntment_limit', 'appoinntment_limit_type', 'visibility')->get();
