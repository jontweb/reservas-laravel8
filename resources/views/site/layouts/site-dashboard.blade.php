						...
						<div class="leftside-menu">
							<div class="card card-box-shadow py-4 mb-3">
								...
								<ul class="nav flex-column pt-3">
									<li class="nav-item pl-3"><a href="{{route('site.client.profile')}}" class="nav-link"><i class="fa fa-user client-menu-icon"></i> Profile</a></li>
									<li class="nav-item pl-3"><a href="{{route('client.dashboard')}}" aria-current="page" class="nav-link"><i class="fa fa-home client-menu-icon"></i> Dashboard</a></li>
									<li class="nav-item pl-3"><a href="{{route('site.client.pending.booking')}}" class="nav-link"><i class="fas fa-clock client-menu-icon"></i> Pending Booking</a></li>
									<li class="nav-item pl-3"><a href="{{route('site.client.done.booking')}}" class="nav-link"><i class="fa fa-check-circle client-menu-icon"></i> Done Booking</a></li>
